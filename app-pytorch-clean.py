...
# Import PyTorch avec gestion des erreurs
try:
    import torch
...
# Import torchvision avec gestion des erreurs
try:
    ...
    print(f"TorchVision non disponible: {e}")
...
def load_model():
    if not PYTORCH_AVAILABLE or not TORCHVISION_AVAILABLE:
        print("PyTorch ou TorchVision non disponible - Mode fallback")
        return None, None
...
if __name__ == '__main__':
    print("=" * 60)
    print("Lafayette Medical AI - Version Hybride")
    print("=" * 60)
    print(f"Device: {device}")
    print(f"PyTorch: {'Disponible' if PYTORCH_AVAILABLE else 'Non disponible'}")
    print(f"TorchVision: {'Disponible' if TORCHVISION_AVAILABLE else 'Non disponible'}")
